...
<div class="zhifu">
  ...
  <div class="com_one">
    ...
    <div class="com_two">
      <ul>
        <li class="father"><span class="one"></span> 支付宝 <span class="two"></span><input class="list ones" name="zfb" disabled></li>
        <li class="father"><span class="therr"></span>微信支付<input class="list" name="wx" disabled></li>
      </ul>
      <p class="monny">去支付</p>
